<%!
    ...
    git_link_template = 'https://github.com/visym/cap/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    #    google_search_query = 'inurl:github.com/visym/cap  site:vipy.github.io  site:vipy.website'
    google_search_query = ''
